...
$posts=[];
if(count($_GET)!=0 && isset($_GET['cat']) && is_string($_GET['cat']))
    $posts=PostsHandler::getAllCatPosts($bd,$_GET['cat']);
?>
...
<?php if(count($posts)!= 0 && count($_GET)!= 0 && isset($_GET['cat']) && is_string($_GET['cat'])) :?>
                    ...
                    <div class="d-flex flex-column align-items-center postCard">
                        ...
                        <section class="inner-card-body">
                            ...
                            <div class="btn btn-primary">
                                <a href="http://localhost/Forum/pages/post.php?id=<?= $post['id'] ?>">Voir plus</a>
                            </div>
                    </div>
                <?php endif;?>
            <?php endforeach; ?>
...
<?php else :?>
    <h3 class="d-flex justify-content-center">Aucune publication n'a été répertoriée</h3>
<?php endif;?>
